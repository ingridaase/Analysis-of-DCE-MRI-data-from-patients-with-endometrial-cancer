...
def find_deterministic_aif(dce): 
    ...
    brightest_voxels = select_brightest_voxels(dce_rel, timesteps=20, percentile=0.5)
    ...
    new_df['number of clusters'] = number_of_clusters
    ...
    #result_path = 'H:/data/Results/AutoAIF/0.5percent_1cluster/AIF_plots/'
    ...
    plt.savefig(os.path.join('/Users/ingridaasecowles/data'))
